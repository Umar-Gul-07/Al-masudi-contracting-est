      ...
      <div className="col-xl-6">
        ...
        <div className="contact-us-content">
          ...
          <div className="section-title">
            <span className="section-sub-title">Contact Us Today</span>
            <h2
              className="text-anime-style-3"
              data-cursor="-opaque"
              aria-label="Connect with our expert for premium tile & marble"
              style={{ perspective: 400 }}
            >
              <div
                className="split-line"
            ...
            >
              Connect with our experienced specialists for premium tile and
              marble solutions designed to elevate every space.
            </p>
          </div>
          {/* Section Title End */}
          ...
          >
            {/* Contact Info Box Header Start */}
            <div
              className="contact-info-box-header wow fadeInUp"
              style={{ visibility: "visible", animationName: "fadeInUp" }}
            >
            ...
            {/* Contact Info Box Header End */}
            {/* Contact Info Box Content Start */}
            <div className="contact-info-box-content">
              <p>
                Experience dependable, 24/7 customer support designed to deliver
                peace of mind at every step.
              </p>
            </div>
            {/* Contact Info Box Content End */}
            {/* Contact Info Box List Start */}
        ...
        <div className="contact-us-form">
          ...
          <div className="section-title">
            ...
            <p
              ...
              style={{ visibility: "visible", animationName: "fadeInUp" }}
            >
              Reach out to our team for product inquiries, project
              consultations, or custom tile and marble solutions tailored to
              your needs.
            </p>
          </div>
          {/* Section Title End */}
  ...
  <div className="container">
    <div className="row section-row">
      <div className="col-lg-12">
        ...
        <div className="section-title section-title-center">
          <span className="section-sub-title">How to Reach Us</span>
          <h2
            className="text-anime-style-3"
            data-cursor="-opaque"
            aria-label="Let's connect & build spaces"
            style={{ perspective: 400 }}
          >
            <div
              className="split-line"
          ...
          >
            Collaborate with us to transform ideas into inspiring spaces. we'll
            create environments that reflect your vision, blending
    ...
    <div className="row">
      <div className="col-lg-12">
        ...
        <div
          className="google-map-iframe wow fadeInUp"
          data-wow-delay="0.4s"
          style={{
            visibility: "visible",
            animationDelay: "0.4s",
