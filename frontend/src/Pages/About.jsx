      ...
      <div className="col-xl-6">
        ...
        <div className="our-values-content">
          ...
          <div className="section-title section-title-center">
            <span className="section-sub-title">Our Values</span>
            <h2
              className="text-anime-style-3"
              data-cursor="-opaque"
              aria-label="Foundational values behind our marble craft"
              style={{ perspective: 400 }}
            >
              <div
                className="split-line"
          ...
          {/* Our Values Image End */}
        </div>
        {/* Our Values Content End */}
      </div>
      <div className="col-xl-6">
        {/* Our value Item List Start */}
        <div className="our-value-item-list">
          {/* Our value Item Start */}
          <div
            className="our-value-item wow fadeInUp"
            style={{ visibility: "visible", animationName: "fadeInUp" }}
          >
            ...
            <div className="our-value-item-content">
              ...
              <p>
                We are committed to delivering superior-quality marble through
                strict quality control, advanced
              </p>
              <ul>
                <li>Committed to deliverin quality</li>
                <li>Committed to deliverin quality</li>
              </ul>
            </div>
          </div>
...
<div className="work-process dark-section">
  <div className="container">
      ...
      <div className="col-lg-12">
        ...
        <div className="section-title section-title-center">
          ...
          <h2
            className="text-anime-style-3"
            data-cursor="-opaque"
            aria-label="Crafted through precision and advanced processes"
            style={{ perspective: 400 }}
          >
            <div
              className="split-line"
    ...
    <div className="row">
      <div className="col-lg-12">
        {/* Work Process Item List Start */}
        <div className="work-process-item-list">
          ...
          >
            ...
            <div className="work-process-item-body">
              <div className="work-process-item-step">
                <p>Step 01</p>
              </div>
              <div className="work-process-item-content">
                <h3>Consultation &amp; Selection</h3>
                <p>
                  We understand your vision. Our experts help you choose the
                  perfect
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="work-process-item-body">
              ...
              <div className="work-process-item-content">
                <h3>Sourcing Premium Materials</h3>
                <p>
                  We source only the finest marbles and tiles from trusted
                  quarries
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="work-process-item-body">
              ...
              <div className="work-process-item-content">
                <h3>Custom Cutting &amp; Finishing</h3>
                <p>
                  Every tile and marble slab is precision-cut and finished
                  according
                </p>
              </div>
            </div>
  ...
  <div className="container">
    <div className="row">
      <div className="col-xl-5">
        ...
        <div
          className="faq-image-box wow fadeInUp"
          style={{ visibility: "visible", animationName: "fadeInUp" }}
        >
          {/* Faqs Image Start */}
          ...
          <div className="faq-cta-box">
            ...
            <div className="faq-cta-item">
              ...
              <div className="faq-cta-content">
                ...
                <p>
                  Our team is here to help. Reach out to us for expert guidance,
                  product details.
                </p>
              </div>
            </div>
        ...
        <div className="faqs-content">
          ...
          <div className="section-title">
            ...
            <h2
              className="text-anime-style-3"
              data-cursor="-opaque"
              aria-label="Helping you make confident tile & marble decisions"
              style={{ perspective: 400 }}
            >
              <div
                className="split-line"
          ...
          <div className="faq-accordion" id="accordion">
            ...
            >
              ...
              >
                <div className="accordion-body">
                  <p>
                    Absolutely. Every product undergoes strict quality control
                    checks at multiple stages production to ensure consistency,
                    durability, and superior finish before delivery.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <h2 className="accordion-header" id="heading2">
                ...
                >
                  Q2. Are your tiles and marble suitable for commercial
                  projects?
                </button>
              </h2>
              <div
            ...
            >
              <h2 className="accordion-header" id="heading4">
                ...
                >
                  Q4. What applications are your tiles and marble best suited
                  for?
                </button>
              </h2>
              <div
            ...
            >
              <h2 className="accordion-header" id="heading5">
                ...
                >
                  Q5. How do I contact your team for support or inquiries?
                </button>
              </h2>
              <div
                id="collapse5"
